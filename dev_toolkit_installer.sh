...
echo "  - zsh (https://www.zsh.org/): Мощная оболочка, настроена с Oh My Zsh и темой Powerlevel10k."
echo "    - Oh My Zsh (https://ohmyz.sh/): Фреймворк для управления конфигурацией Zsh."
echo "    - Powerlevel10k (https://github.com/romkatv/powerlevel10k): Тема для Zsh."
echo "  - zsh-autosuggestions (https://github.com/zsh-users/zsh-autosuggestions): Предлагает команды во время набора."
echo "  - zsh-syntax-highlighting (https://github.com/zsh-users/zsh-syntax-highlighting): Подсвечивает синтаксис команд."
echo "  - bat (https://github.com/sharkdp/bat): Улучшенный 'cat'. Используйте: bat <файл>."
echo "  - lazydocker (https://github.com/jesseduffield/lazydocker): Терминальный UI для Docker. Запуск: lazydocker."
echo "  - yazi (https://github.com/sxyazi/yazi): Терминальный файловый менеджер. Запуск: yazi."
echo "  - htop (https://htop.dev/): Интерактивный просмотрщик процессов. Запуск: htop."
echo "  - btop (https://github.com/aristocratos/btop): Современный просмотрщик ресурсов. Запуск: btop."
echo "  - glances (https://nicolargo.github.io/glances/): Обзорный монитор системы. Запуск: glances."
echo "  - mtr (https://www.bitwizard.nl/mtr/): Диагностика сети. Запуск: mtr <хост> (mtr-tiny - это легковесная версия)."
echo "  - fzf (https://github.com/junegunn/fzf): Fuzzy finder. Интеграция с Ctrl+R и др."
echo "--------------------------------------------------------------------"